  ...
  return (
    <div style={{ background: "linear-gradient(135deg, #111827 0%, #0F1419 100%)", minHeight: "100vh", padding: "20px", color: "#F9FAFB", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto" }}>
      <div style={{ marginBottom: 24, marginTop: 12 }}>
        <div style={{ fontSize: 28, fontWeight: 700, marginBottom: 4, letterSpacing: -0.5 }}>Your Energy OS</div>
        <div style={{ fontSize: 14, color: "#6B7280" }}>{connectedDevices.length} of {ALL_DEVICES.length} devices connected</div>
      </div>

      <div style={{ background: "linear-gradient(135deg, #16A34A40 0%, #16A34A20 100%)", border: "1px solid #16A34A60", borderRadius: 16, padding: "20px", marginBottom: 20 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
          <div>
            <div style={{ fontSize: 12, color: "#6B7280", marginBottom: 4 }}>Saving this month</div>
      ...
      <div style={{ marginBottom: 20 }}>
        <div style={{ fontSize: 13, fontWeight: 600, color: "#9CA3AF", marginBottom: 10, textTransform: "uppercase", letterSpacing: 0.5 }}>Connected Devices</div>
      ...
      {nextDevice && (
        <div style={{ marginBottom: 24 }}>
          <div style={{ fontSize: 13, fontWeight: 600, color: "#9CA3AF", marginBottom: 10, textTransform: "uppercase", letterSpacing: 0.5 }}>Unlock More</div>
          <button style={{ width: "100%", background: `${nextDevice.color}20`, border: `2px solid ${nextDevice.color}40`, borderRadius: 10, padding: "14px", display: "flex", alignItems: "center", justifyContent: "space-between", cursor: "pointer" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{ background: `${nextDevice.color}40`, borderRadius: 8, padding: 8, display: "flex", alignItems: "center", justifyContent: "center" }}>
      ...
      <div style={{ background: "#0D1F14", border: "1px solid #16A34A40", borderRadius: 12, padding: "14px" }}>
        <div style={{ fontSize: 10, color: "#16A34A", fontWeight: 700, letterSpacing: 1.2, marginBottom: 6 }}>GRIDLY DECISION</div>
        <div style={{ fontSize: 16, fontWeight: 800, color: "#22C55E", marginBottom: 4, letterSpacing: -0.5 }}>HOLDING</div>
        <div style={{ fontSize: 12, color: "#9CA3AF" }}>Price 18.4p — waiting for cheaper slot at 10:30 (12.1p)</div>
      </div>
    </div>
  );
}
